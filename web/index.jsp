...
<h1>Future Value Calculator</h1>
  <form action="calculate" method="post">
    ...
    <p><label class="left">Investment Amount</label><input class="right"
      name="amount" type="number" title="Your Investment Amount" 
      min="0" step="any" autofocus required /></p>
    <p><label class="left">Yearly Interest Rate</label><input class="right" 
      name="rate" type="number" title="Yearly Interest Rate" min="0" required /></p>
